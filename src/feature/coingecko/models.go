...
const (
	OrderTypeMarketCapDesc OrderType = "market_cap_desc"
	OrderTypeMarketCapAsc  OrderType = "market_cap_asc"
	OrderTypeGeckoDesc     OrderType = "gecko_desc"
	OrderTypeGeckoAsc      OrderType = "gecko_asc"
	OrderTypeVolumeAsc     OrderType = "volume_asc"
	OrderTypeVolumeDesc    OrderType = "volume_desc"
)
